...
export const metadata: Metadata = {
    ...
    verification: {
        google: 'tLfSpiu2wo8F0ezhY6E2JIsUw2hkyufiANgoLuJ4f0o',
        yandex: 'e1bd5a633ca356e5',
    },
};
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "url": "https://video-bokep.pages.dev",
        "description": `${SITENAME} Video bokep indo jepang indonesia barat terbaru viral korea simontok china tante live sma paksa ngentot abg jilbab cewek bocil smp pijat pelajar.`,
        "image": "https://video-bokep.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://video-bokep.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://video-bokep.pages.dev/?q={search_term}", 
